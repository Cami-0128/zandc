                ...
                case "彈跳器":
                    ...
                    if (BouncerSpawnManager.Instance != null)
                    {
                        ...
                        if (bouncerEffect != null)
                        {
                            ...
                            Debug.Log("✓ 注入 SimpleBouncerEffect 成功");
                        }
                        else
                        {
                            item.effect = null;
                            Debug.LogError("✗ SimpleBouncerEffect 創建失敗！請檢查 BouncerSpawnManager 的設定。");
                        }
                    }
                    else
                    {
                        item.effect = null;
                        Debug.LogError("✗ 缺少 BouncerSpawnManager！請在場景中創建物件並掛載 BouncerSpawnManager.cs");
                    }
                    break;
                // =============================================
