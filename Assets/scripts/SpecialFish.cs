...
/// <summary>
/// 特殊魚 V4 - 使用 FishBullet 替代 HeavyBullet
/// 整合捕捉技能支持
/// </summary>
public class SpecialFish : MonoBehaviour
{
    ...
    public GameObject fishBulletPrefab;  // ✅ 使用 FishBullet
    ...
    void AttackTarget(Vector3 targetPos)
    {
        ...
        {
            Debug.LogError("[SpecialFish] FishBullet 預製物缺少 FishBullet 腳本");
        }
